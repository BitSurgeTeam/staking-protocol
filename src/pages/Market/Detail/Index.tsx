...
export default function MarketDetail() {
  ...
  return (
    <>
      ...
      <div className="py-10 relative px-6 xl:px-0 xl:mx-auto xl:max-w-[1200px]">
      <Header/>
        <h3
          ...
          <div className="w-full xl:w-[500px] flex flex-col gap-y-5">
            <div className="w-full flex items-center h-[50px] bg-[#0E0F16] rounded-[40px]">
              ...
              <div
                ...
                className={[
                  "flex-1 rounded-[40px] h-full flex items-center justify-center",
                  operation === "liquidity" ? "bg-[#2CA94F]" : "cursor-pointer",
                ].join(" ")}
              >
                Liquidity
              </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="bg-[#242632] rounded-[30px] text-sm">
                    <span
                      onClick={() => setType("APY")}
                      className={[
                        type === "APY" && "bg-[#2CA94F] rounded-[30px]",
                    ...
                    <span
                      ...
                      className={[
                        type === "Price" && "bg-[#2CA94F] rounded-[30px]",
                        "py-1 px-3.5 cursor-pointer",
                      ].join(" ")}
                    >
                      Price
